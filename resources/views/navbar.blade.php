      ...
      <header class="header_section">
        <nav class="navbar navbar-expand-lg custom_nav-container">
          <a class="navbar-brand" href="index.html">
            <span> SINAR ELEKTRONIK PINRANG </span>
          </a>
          <button
                  ...
                  <div class="row">
                    <div class="col-md-7">
                      <div class="detail-box">
                        <h1>
                          Welcome To <br />
                          SINAR ELEKTRONIK PINRANG
                        </h1>
                        <p>
                          Toko Elektronik Top di daerah Pinrang. Menjual
                          berbagai macam barang Elektronik dengan harga yang
                          terjangkau dan masih bisa nego.
                        </p>
                        <a href=""> Contact Us </a>
                      </div>
                    </div>
